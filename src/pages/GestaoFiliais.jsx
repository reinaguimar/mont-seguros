...
// Preco fixo (premio bruto) padrao do RCF-V por LMI. Fallback quando a filial ainda nao configurou.
...
export default function GestaoFiliais() {
  ...
  const salvar = async () => {
    ...
    // Precos fixos do RCF-V: gravados em 3 campos numericos (persistem sempre).
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              ...
              <div className="border rounded-md p-3 space-y-2">
                ...
                {/* Subgrupo RCF-V por LMI (com preco fixo configuravel) */}
                <div className="mt-2 pt-2 border-t border-slate-100">
                  <p className="text-sm font-medium text-slate-700 mb-1">RCF-V (Danos a Terceiros)</p>
                  <p className="text-xs text-slate-500 mb-2">Produto de preco fixo — defina o premio (R$) cobrado por LMI. Esse valor e aplicado na emissao.</p>
                    ...
                    {RCFV_LMIS.map(opcao => {
                      ...
                      <div key={opcao.value} className="flex items-center justify-between gap-2">
                        ...
                        <div className={`flex items-center gap-1 ${marcado ? "" : "opacity-40"}`}>
                          <span className="text-xs text-slate-500">Premio R$</span>
                          <input
                            type="text"
                            inputMode="decimal"
                            disabled={!marcado}
